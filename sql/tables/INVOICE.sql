CREATE TABLE `INVOICE` (
  ...
  `INVOICE_PAYPAL_EMAIL` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `INVOICE_PAYPAL_DATE` date DEFAULT NULL,
  `INVOICE_PAYPAL_VIEW_URL` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `INVOICE_TIP_AMOUNT` decimal(10,2) UNSIGNED NOT NULL DEFAULT '0.00',
